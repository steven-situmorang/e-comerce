    ...
    <div class="container p-0">
      <div class="row">
        ...
        <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
          ...
          <div class="row">
            <?php 
            $data = mysqli_query($koneksi,"SELECT * FROM produk where produk_harga_diskon!=0 ORDER BY produk_id DESC");
            while($d = mysqli_fetch_array($data)){
              ...
              <div class="col-lg-4 col-sm-6">
                <div class="product text-center">
                  ...
                  <p class="small text-muted"><del><?php echo "Rp.".number_format($d['produk_harga']); ?></del> <span><?php echo "Rp.".number_format($d['produk_harga_diskon']); ?></span></p>
                </div>
              </div>
              <?php
            }
